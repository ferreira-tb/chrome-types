...
pub async fn allow_camera(pattern: &str) -> JsResult<()> {
...
pub async fn block_camera(pattern: &str) -> JsResult<()> {
...
pub async fn allow_clipboard(pattern: &str) -> JsResult<()> {
...
pub async fn block_clipboard(pattern: &str) -> JsResult<()> {
...
pub async fn allow_cookies(pattern: &str) -> JsResult<()> {
...
pub async fn block_cookies(pattern: &str) -> JsResult<()> {
...
pub async fn allow_fullscreen(pattern: &str) -> JsResult<()> {
...
pub async fn allow_javascript(pattern: &str) -> JsResult<()> {
...
pub async fn block_javascript(pattern: &str) -> JsResult<()> {
...
pub async fn allow_location(pattern: &str) -> JsResult<()> {
...
pub async fn block_location(pattern: &str) -> JsResult<()> {
...
pub async fn allow_microphone(pattern: &str) -> JsResult<()> {
...
pub async fn block_microphone(pattern: &str) -> JsResult<()> {
